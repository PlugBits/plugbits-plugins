(() => {
  ...
  const fields = ['apiBaseUrl', 'tenantId', 'drawingNoField', 'productNameField', 'pdfFileField', 'materialField', 'dimensionField', 'tagField', 'tagSpaceId', 'processField', 'processOptions'];
